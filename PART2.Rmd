---
title: "RNA-seq analyis: Part 2 ( differential gene analysis and gene-pathway enrichment )" 
...
ploting the first 2 PCs with the variables that seem to be contributing to the most variance in the data.
...
moving into DE analysis: we're going to use the limma package, rather than the more popular DESeq2 or edgeR packages. There's broadly 3 steps to pulling out DE genes:  
